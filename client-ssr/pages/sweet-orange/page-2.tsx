...
const stringData: string = '[{"blockPath":"headers/Header1/Header1","blockIsHidden":false,"blockConfigs":{"hiddenOnDevice":[],"buttonBackground":"#ca4a00","blockAlign":"center","titleFontSize":"300%"},"blockContent":{"titleText":"Черный 1","descriptionText":"Какой-то текст описывающий свойства продукта или услуги","buttonText":"Кнопка"}},{"blockPath":"headers/Header1/Header1","blockIsHidden":false,"blockConfigs":{"hiddenOnDevice":[],"buttonBackground":"#ca4a00","blockAlign":"center","titleFontSize":"300%"},"blockContent":{"titleText":"Черный 2","descriptionText":"Какой-то текст описывающий свойства продукта или услуги","buttonText":"Кнопка"}}]'
...
export const getServerSideProps: GetServerSideProps = async () => {
	...
	const pageId = '61349dae9fefec0bc8f0fbd8'
