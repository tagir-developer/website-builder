...
const stringData: string = '[{"blockPath":"headers/Header2/Header2","blockIsHidden":false,"blockConfigs":{"hiddenOnDevice":[],"buttonBackground":"#7dca00","blockAlign":"center","titleFontSize":"400%","buttonAnimation":"scale","titleColor":"#004223"},"blockContent":{"titleText":"Апельсин","descriptionText":"Какой-то текст описывающий свойства продукта или услуги","buttonText":"Кнопка","backgroundImage":"/images/blocks/default/headers/1/header1content.jpg"}}]'
...
export const getServerSideProps: GetServerSideProps = async () => {
	...
	const pageId = '614485eef118f721606fa213'
